          ...
          },
          {
            ...
            value:
              process.env.NODE_ENV === 'development'
                ...
                : "default-src 'self' data:; connect-src 'self' https://api.pwnedpasswords.com http://localhost:4000 https://proyecto-7mo-backend.onrender.com https://www.google.com; script-src 'self' 'unsafe-inline' https://www.google.com https://www.gstatic.com https://www.google.com/recaptcha/api2/clr; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://res.cloudinary.com; frame-src 'self' https://www.google.com https://www.gstatic.com;", // Agregado reCAPTCHA
          },
        ],
      },
    ];
